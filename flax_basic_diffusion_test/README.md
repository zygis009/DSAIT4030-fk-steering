...
## Getting started
1. Make sure the following code works by running `python flax_test_sd.py`, this will download StableDiffusion1.4 and generate one inference sample using the device's GPU.